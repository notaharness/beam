...
// the repository's LICENSE and its README, ready for npm publish as it is.
//
...
const platformReadme = new URL("platform/README.md", import.meta.url);
...
for (const name of Object.keys(shim.optionalDependencies)) {
  ...
  copyFileSync(platformReadme, `${dir}/README.md`);
